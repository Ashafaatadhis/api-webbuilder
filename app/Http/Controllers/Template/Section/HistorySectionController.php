...
use App\Http\Requests\Template\Section\HistorySectionRequest;
...
class HistorySectionController extends Controller
{
     ...
     */
    public function store(HistorySectionRequest $request)
    {
    ...
    {
        $section = HistorySection::find($id);
     ...
     */
    public function update(HistorySectionRequest $request, string $id)
    {
        ...
        $section = HistorySection::where('id', $id)->first();
        $data = new SectionCollection(collect($section));
