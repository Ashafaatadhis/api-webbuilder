...
use App\Http\Requests\Template\Section\ProductSectionRequest;
...
class ProductSectionController extends Controller
{
     ...
     */
    public function index(ProductSectionRequest $request)
    {
        $limit = $request->query('limit', 10);
        $section = ProductSection::paginate($limit);
    ...
    public function show(string $id)
    {
        ...
        if (!$section) {
            return $this->sendError("Not Found", "Product Section Not found", Response::HTTP_NOT_FOUND);
        }
     ...
     */
    public function update(ProductSectionRequest $request, string $id)
    {
        ...
        $section = ProductSection::where('id', $id)->first();
        $data = new SectionCollection(collect($section));
