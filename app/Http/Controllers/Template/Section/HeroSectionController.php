...
use App\Http\Requests\Template\Section\HeroSectionRequest;
...
class HeroSectionController extends Controller
{
     ...
     */
    public function index(HeroSectionRequest $request)
    {
        $limit = $request->query('limit', 10);
        $section = HeroSection::paginate($limit);
    ...
    public function show(string $id)
    {
        ...
        if (!$section) {
            return $this->sendError("Not Found", "Hero Section Not found", Response::HTTP_NOT_FOUND);
        }
     ...
     */
    public function update(HeroSectionRequest $request, string $id)
    {
        ...
        $section = HeroSection::where('id', $id)->first();
        $data = new SectionCollection(collect($section));
