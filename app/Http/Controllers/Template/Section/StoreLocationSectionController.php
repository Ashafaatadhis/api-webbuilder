...
use App\Http\Requests\Template\Section\StoreLocationSectionRequest;
...
class StoreLocationSectionController extends Controller
{
     ...
     */
    public function store(StoreLocationSectionRequest $request)
    {
        ...
        $section = StoreLocationSection::create($data);
    ...
    {
        $section = StoreLocationSection::find($id);
     ...
     */
    public function update(StoreLocationSectionRequest $request, string $id)
    {
        ...
        $section = StoreLocationSection::where('id', $id)->first();
        $data = new SectionCollection(collect($section));
